...
# Load monthly surface temperature predictions for the globe from 2015 to 2099 from the HadGEM3-GC31-LL model, from the SSP5-8.5 and SSP1-2.6 scenarios.

c = cdsapi.Client()

# import SSP5_8.5 data as zip file
...
c.retrieve(
    ...
    './download_hadgem3_gc31_ll_8.5.zip')


# import SSP1_2.6 data as zip file
...
c.retrieve(
    ...
    './download_hadgem3_gc31_ll_2.6.zip')


# convert files from zip to netcdf

with zipfile.ZipFile('./download_hadgem3_gc31_ll_8.5.zip', 'r') as zip_ref:
    zip_ref.extractall()

with zipfile.ZipFile('./download_hadgem3_gc31_ll_2.6.zip', 'r') as zip_ref:
    zip_ref.extractall()
